...
#ifndef BACKEND_INFER_BACKEND_IMP3_H
#define BACKEND_INFER_BACKEND_IMP3_H
...
class BackendImpl3 final : public backend_infer::Service
{
private:
    //TFUtils         _tfu;
    LPCNetState*    _lpcnet;
...
#endif //BACKEND_INFER_BACKEND_IMP3_H
