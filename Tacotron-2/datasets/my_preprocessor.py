...
def build_from_path(hparams, input_wave_dir, pinyin_anno_file, 
	...
	with open(pinyin_anno_file) as f:
		while True:
			line1 = f.readline()
			if not line1:
				break
